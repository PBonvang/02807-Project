...
dbscan.fit(normalized_feature_data)
print('[Determining clusters] Done')
# %% Save clusters
db_clusterings = dbscan.labels_
np.save(f'data/clusterings/DBSCAN_clusterings_minmax_eps{eps}_ms{min_samples}_DS_reduced_and_dropped.npy', db_clusterings)