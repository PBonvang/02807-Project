        ...
        with data_path.open(encoding='utf-8') as file:
            ...
            while line := file.readline():
                if LIST_IDENTIFIER in line:
                    ...
                    file_metadata[list_name] = {'start_line':i, 'attributes':list_attributes}
                    ...
                    list_attributes.append(get_attribute_from_json_line(line))
    ...
    with tqdm(total=list_metadata['end_line']) as pbar:
        with json_file.open(encoding='utf-8') as file:
            with output_file.open('w', encoding='utf-8',newline='') as output_file:
                csvwriter = csv.DictWriter(output_file, fieldnames=list_metadata['attributes'])
